  ...
  return (
    ...
    <section className="bg-white" id='about'>
      <div className="container mx-auto px-0 md:px-6 py-12 flex flex-col md:flex-row items-center justify-between">
        ...
        >
          <img 
            src="https://coolwaveconsulting.com/wp-content/uploads/2023/11/a-healthcare-worker-examining-pregnant-woman-indoors-at-home-.jpg" // Replace with your actual image path
