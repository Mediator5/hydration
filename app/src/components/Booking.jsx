        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white rounded-2xl p-8 lg:p-12 shadow-xl">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Ready to feel your best? Schedule your mobile IV therapy session today. We bring everything to you—so you can relax, hydrate, and recharge without leaving your space.
            </p>
            ...
            <div className="space-y-5">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-600 focus:border-transparent text-gray-800 placeholder-gray-400"
                />
                <input
                  type="tel"
                  name="phone"
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-600 focus:border-transparent appearance-none cursor-pointer text-gray-800"
                  >
                ...
                <div className="relative">
                  <input
                    ...
                    value={formData.date}
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-600 focus:border-transparent text-gray-800"
                  />
                </div>
              </div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={5}
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-600 focus:border-transparent resize-none text-gray-800 placeholder-gray-400"
              ></textarea>
